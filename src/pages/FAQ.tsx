...
const FAQ = () => {
    return (
        <div className="container mx-auto mt-8">
            <h2 className="text-center text-primary text-2xl sm:text-3xl md:text-4xl font-extrabold mb-16">
            ...
            <div className="flow-root">
                <div className="-my-4 flex flex-col divide-y divide-gray-200">
                    <details className="group py-4 [&_summary::-webkit-details-marker]:hidden" open>
                        <summary className="flex items-center justify-between gap-1.5 text-foreground">
