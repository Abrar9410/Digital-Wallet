...
const Contact = () => {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        emailjs
            .sendForm(
                config.emailServiceId,   // Your EmailJS service ID (e.g., Gmail)
                config.emailTemplateId,  // Your EmailJS template ID
                e.target as HTMLFormElement,                                // The form itself
                {publicKey: config.emailUserId}       // Your EmailJS user ID (provided in your account)
            )
            .then(
                () => {
    ...
    return (
        <div id="contact" className="bg-primary dark:bg-black mt-8 py-4">
