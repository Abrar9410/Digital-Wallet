...
const Footer = () => {
    return (
        <div className="bg-primary p-8 mt-8">
            <div className="container mx-auto grid grid-cols-1 gap-5 sm:grid-cols-3 sm:gap-0">
                <div className="flex flex-col items-center max-sm:gap-2">
                    ...
                    <p className="text-white max-[200px]:text-sm text-center sm:text-start sm:pt-6">
                        Your digital wallet. Hands free, money on the go!
                    </p>
                </div>
            ...
            <p className="text-center text-xs min-[435px]:text-sm text-white/60">Copyright © {new Date().getFullYear()} - All rights reserved by Digital Wallet Ltd</p>
        </div>
    );
};
